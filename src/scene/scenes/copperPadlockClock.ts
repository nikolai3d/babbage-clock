 ...
 * concrete second ring configuration: everything except the ring count and the
 * mode is inherited from the copper padlock, and no render code knows the
 * difference. Spacing is unchanged on purpose — six drums on the same arbor
